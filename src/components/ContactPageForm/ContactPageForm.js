...
const ContactPageForm = ({ dataForm }) => {
    ...
    const shortData = data.wpPage.homepage.formularzKontaktowy.trescWiadomosciPoPoprawnymPrzeslaniu;
    const images = withArtDirection(getImage(dataForm.zdjecieDlaFormularza.localFile), [
      {
            ...
            <StyledRightWrapper>
                {isSend ?
                    <>
                        <StyledMessageWrapper>
                            <StyledTitle>
                                {parse(shortData.tytul)}
                            </StyledTitle>
                            <StyledSubTitle>
                                {parse(shortData.podTytul)}
                            </StyledSubTitle>
                            <StyledDesc>
                                {parse(shortData.opis)}
                            </StyledDesc>
                            <StyledButtonsWrapper>
                                <Button
                    ...
                    <>
                        <StyledHeading>
                            <StyledTitleImage>
                                <GatsbyImage
                                    image={getImage(dataForm.zdjecieDlaTytuluFormularza.localFile)}
