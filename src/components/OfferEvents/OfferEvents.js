...
const OfferEvents = () => {
  return (
    <StyledOfferEvents>
        ...
        <StyledText>
            Biorę udział w wymienionych wydarzeniach. 
            Wystawiam się przez kilka dni i osobiście
            jestem na miejscu. Serdecznie zapraszam do
            odwiedzin, zobaczenia wystawy oraz odbycia
            przyjemnej rozmowy.
        </StyledText>
        <StyledEventsWrapper>
            <OfferEvent />
