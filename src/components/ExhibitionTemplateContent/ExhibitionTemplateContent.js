  ...
  return (
    <StyledExhibitionTemplateContent>
      ...
      <StyledContentWrapper>
        ...
        {exhibitionData.wystawa.wydarzenieSzablon.ktoryArtykulPolecicNaDoleStrony && 
          <ChooseArticle chosenArticle={exhibitionData.wystawa.wydarzenieSzablon?.ktoryArtykulPolecicNaDoleStrony} />
        }
      </StyledContentWrapper>
    </StyledExhibitionTemplateContent>
  );
